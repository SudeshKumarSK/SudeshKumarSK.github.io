...
const EventsCard = ({
  ...
  const handleFavourites = () => {
    ...
    const newFavourite: Favourites = {
      ...
      eventDate: (eventCardData?.eventDate)? eventCardData?.eventDate : "",
      category: (eventDetails?.segment ||
        eventDetails?.genre ||
        eventDetails?.subGenre ||
        eventDetails?.type ||
        eventDetails?.subType) ? handleGenres(eventDetails?.segment, eventDetails?.genre, eventDetails?.subGenre, eventDetails?.type, eventDetails?.subType) : "",

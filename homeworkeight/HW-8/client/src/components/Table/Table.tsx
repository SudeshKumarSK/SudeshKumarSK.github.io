...
interface TableProps {
  ...
  onSelectEvent: (eventId: string | null, eventName: string | null, eventDate: string | null) => void;
}
...
const Table = ({ searchDetails, onSelectEvent }: TableProps) => {
  ...
  const handleEventClick = async (eventDetail: SearchDetails) => {
    ...
    const eventDate = eventDetail.localDate;
    
    /* */
    onSelectEvent(eventId, eventName, eventDate);
  };
